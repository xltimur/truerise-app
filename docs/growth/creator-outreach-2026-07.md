...
| Creator | Channel | Contact URL | Audience fit | Sent date | Reply | Store URL used | Notes |
|---|---|---|---|---|---|---|---|
|  |  |  |  |  |  |  |  |
...
- Do not ask for fake installs or incentivized reviews.
- Use custom product page / custom listing URLs only after they are live and verified.
