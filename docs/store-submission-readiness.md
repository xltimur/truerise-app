...
- Apple App Privacy ("nutrition label") answers and Play Data Safety form.
  **[PARTIAL — authored prep: drafts in `docs/apple-privacy-labels.md` +
  `docs/play-data-safety.md` map the verified data flow; App Store Connect /
  Play Console entry + owner/legal sign-off remain]**
